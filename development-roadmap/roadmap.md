...
- [x] **AI問題自動生成** — Gemini 2.0 Flash 連携 / generateCardsSchema (Zod) / generateCards service / POST /api/ai/generate / GenerateForm・GeneratedCardItem・GeneratedCardList / /ai/generate ページ / AppNav AI生成リンク追加 (`.steering/20260425-AI問題自動生成`)
